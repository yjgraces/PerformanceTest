...
public class yidao_Estimated_https extends AbstractJavaSamplerClient implements Serializable {
...
//		name = context.getParameter(TestElement.NAME);
	...
	public  SampleResult runTest(JavaSamplerContext context) {
		...
		estimateMapParams.put("city", "hlbe");
		estimateMapParams.put("car_type_id", "3");
		estimateMapParams.put("time_length", "1800");
		estimateMapParams.put("corp_id", "");
		estimateMapParams.put("is_asap", "1");		
		estimateMapParams.put("start_time", (System.currentTimeMillis()/1000)+"");
		estimateMapParams.put("nonce", (System.currentTimeMillis()/1000)+"");
		...
		results.setSamplerData("Data:\n getEstimated:"+url+getSign.doGetParamsStr(estimateMapParams)+"Token:"+accessToken+"sign:"+sign);
