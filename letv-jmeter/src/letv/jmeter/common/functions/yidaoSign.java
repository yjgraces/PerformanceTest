 ...
 *
 */
public class yidaoSign extends AbstractFunction {
	
	private static final List<String> desc = new LinkedList<String>();
//	private static final CopyOnWriteArrayList<String> desc = new CopyOnWriteArrayList<>();
	private static final String KEY = "__yidaoSign";
	...
	public String execute(SampleResult previousResult, Sampler currentSampler) throws InvalidVariableException {
		...
		//System.out.println("Jmeter签名字符串=="+srcValue);
		getSign getsign=new getSign();
		String yidaosign=getsign.getSignKeyAsString(srcValue);
		return yidaosign;
	}
