...
public class Actions
{
	...
	public int estimate(){
		...
		estimateMapParams.put("start_latitude", "38.77"+lr.eval_string("<lat>")+"");
		estimateMapParams.put("end_latitude", "38.77"+lr.eval_string("<lat>")+"");		    
		estimateMapParams.put("start_longitude", "82.68"+lr.eval_string("<lng>")+"");
		estimateMapParams.put("end_longitude", "82.68"+lr.eval_string("<lng>")+"");	    	    
		estimateMapParams.put("passenger_phone",""+lr.eval_string("<phone>")+"" );
		...
		// 
		web.add_header("Authorization","Bearer "+""+lr.eval_string("<token>")+"");
		...
		if (lr.eval_int(""+lr.eval_string("<getEstimatedCostSuccess>")+"") == 0){
	...
	public int creatOrder(){
	     ...
	     creatOrderMapParams.put("start_lng","82.68"+lr.eval_string("<lng>")+"");
	     creatOrderMapParams.put("start_lat","38.77"+lr.eval_string("<lat>")+"");
	     creatOrderMapParams.put("end_lat","38.77"+lr.eval_string("<lat>")+"");
	     creatOrderMapParams.put("end_lng","82.68"+lr.eval_string("<lng>")+"");
	     creatOrderMapParams.put("order_lng","82.68"+lr.eval_string("<lng>")+"");
	     creatOrderMapParams.put("order_lat","38.77"+lr.eval_string("<lat>")+"");
	...
	lr.start_transaction("创建系统决策订单createSysOrder");
		...
		if (lr.eval_int(""+lr.eval_string("<creatOrderSuccess>")+"") == 0){
	...
	public int cancelOrder(){
		...
		cancelOrderMapParams.put("order_id",""+lr.eval_string("<service_order_id>")+"");
		...
		if (lr.eval_int(""+lr.eval_string("<CancelOrderSuccess>")+"") == 0){
		    lr.end_transaction("取消订单cancelOrder", lr.FAIL);
		    lr.message("取消订单失败:"+""+lr.eval_string("<service_order_id>")+""); 
		}
		else {
	...
	*/
	...
	public int getStatus(){
		...
		"LAST"});  
	     ...
	     orderStatusMapParams.put("order_id",""+lr.eval_string("<service_order_id>")+"");
		...
		while (lr.eval_int(""+lr.eval_string("<getOrderStatus>")+"") == 0&&i<3){
		    lr.think_time(1);
		    web.reg_find("Text=\"status\":\"4", new String []{"SaveCount=getOrderStatus", "LAST"});
		    orderStatusMapParams.put("order_id",""+lr.eval_string("<service_order_id>")+"");
		  //   orderStatusMapParams.put("order_id",service_order_id);
